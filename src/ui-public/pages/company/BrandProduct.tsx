...
import { Badge, BottomDrawer, Button, HeaderNew, Typography } from '../../../ui-shared/components';
import Ionicons from 'react-native-vector-icons/Ionicons';
import ProductsLoading from '../../loadings/ProductsLoading';
import ProductBrands from '../../components/Products';
...
function BrandProduct() {
  ...
  const route = useRoute<RouteProp<PublicHomeStackParamList, 'BrandProduct'>>();
                  ...
                  [
                    ...
                    return (
                      <Button
                        ...
                        onPress={() => handleFieldChange('prdcat', item.id)}
                        size="lg"
                        right={(
                          <Typography size="sm" color={selected ? '#0d674e' : 'primary'}>
                            {selected ? <Ionicons name="md-checkbox" size={16} color={'#0d674e'} /> : null}
                        ...
                        <Typography style={{ marginLeft: 5}}>{item.ds}</Typography>
                      </Button>
                    );
                  })
                )}
