...
function ProductDetail() {
  ...
  const warnaDefault = pilihan.colors?.find(item => Number(item.id) === 18)
  const defaultColor = '- Pilih -' //route.params.product?.jeniswarna === 'clear' ? 'Clear' : warnaDefault?.nm_warna
    ...
    if (tipe == 'contactlens') {
      if(productModel.package === 1){
        if(fields.color != "" && fields.color2 != ""){
          ...
          if(fields.spheries === ""){
            ToastAndroid.show(`${''}Power mata kiri belum dipilih!`, ToastAndroid.LONG)
          }else if(cekBaseCurve == false){
            ToastAndroid.show(`${''}Base Curve mata kiri belum dipilih!`, ToastAndroid.LONG)
          }else if(fields.jumlah === 0){
            ToastAndroid.show(`${''}Qty mata kiri belum dipilih!`, ToastAndroid.LONG)
          }else if(cekBaseCurve == true || fields.spheries != "" || fields.jumlah == 0){
            toCartLens()
          }else{
            toCartLens()
          ...
          if(fields.spheries2 === ""){
            ToastAndroid.show(`${''}Power mata kanan belum dipilih!`, ToastAndroid.LONG)
          }else if(cekBaseCurve == false){
            ToastAndroid.show(`${''}Base Curve mata kanan belum dipilih!`, ToastAndroid.LONG)
          }else if(fields.jumlah2 === 0){
            ToastAndroid.show(`${''}Qty mata kanan belum dipilih!`, ToastAndroid.LONG)
          }else if(cekBaseCurve2 == true || fields.spheries2 != "" || fields.jumlah2 == 0){
            toCartLens()
          }else{
            toCartLens()
          }
        }else if(fields.color == "" && fields.color2 == "" && fields.spheries == "" && fields.spheries2 == "" &&
      ...
      if (fields.color3 == '') {
        ToastAndroid.show(`${''}Warna belum dipilih!`, ToastAndroid.LONG)
      } else if (fields.spheries3 == '') {
        if(productModel.merk?.substring(0, 5) == 'ADLEN'){
          toCartAccessories()
        }else{
          ToastAndroid.show(`${''}Addition belum dipilih!`, ToastAndroid.LONG)
        }
      } else {
        toCartAccessories()
      }
  ...
  let bcurve = pilihanBaseCrv.basecrv?.length === 1 ? pilihanBaseCrv.basecrv.map(item => {return item.id}) : null
  let bcurve2 = pilihanBaseCrv2.basecrv2?.length === 1 ? pilihanBaseCrv2.basecrv2.map(item => {return item.id}) : null
    ...
    const payload = [
      {
        ...
        pid: pilihanBaseCrv.basecrv?.length === 1 ?
             product.model?.prd_id+bcurve+_isColor?.kd_warna+'M'+_isSpheries?.kd_sph+'0000' : 
             product.model?.prd_id+fields.basecurve+_isColor?.kd_warna+'M'+_isSpheries?.kd_sph+'0000',
        atributColor: fields.color,
        atributSpheries: fields.spheries,
        atributBcurve: fields.basecurve2 || bcurve2,
        paket: productModel.package,
        hargapaket: productModel.package === 1 && fields.color != '' ? productModel.harga : (
          productModel.package > 1 && fields.color != '' && fields.color2 != '' ? Number(productModel.harga)/2 : 
          productModel.package > 1 && fields.color != '' || fields.color2 == '' ? Number(productModel.harga) : Number(productModel.harga)
        ),
        qty: productModel.package === 1 && fields.color != '' ? fields.jumlah : (
          productModel.package > 1 && fields.color != '' && fields.color2 != '' ? Number(productModel.package)/2 : 
          productModel.package > 1 && fields.color != '' || fields.color2 === '' ? Number(productModel.package) : fields.jumlah
        ),
        diff: isDiffLens(),
      },
      {
        ...
        product: _omit(product.model || undefined, 'product_info'),
        pid: pilihanBaseCrv.basecrv?.length === 1 ?
             product.model?.prd_id+bcurve2+_isColor2?.kd_warna+'M'+_isSpheries2?.kd_sph+'0000' : 
             product.model?.prd_id+fields.basecurve2+_isColor2?.kd_warna+'M'+_isSpheries2?.kd_sph+'0000',
        atributColor: fields.color2,
        atributSpheries: fields.spheries2,
        atributBcurve: fields.basecurve2 || bcurve2,
        paket: productModel.package,
        hargapaket: productModel.package === 1 && fields.color2 != '' ? productModel.harga : (
          productModel.package > 1 && fields.color != '' && fields.color2 != '' ? Number(productModel.harga)/2 : 
          productModel.package > 1 && fields.color === '' || fields.color2 != '' ? Number(productModel.harga) : Number(productModel.harga)
        ),
        qty: productModel.package === 1 && fields.color2 != '' ? fields.jumlah2 : (
          productModel.package > 1 && fields.color != '' && fields.color2 != '' ? Number(productModel.package)/2 : 
          productModel.package > 1 && fields.color === '' && fields.color2 != '' ? Number(productModel.package) : fields.jumlah2
        ),
        diff: isDiffLens(),
      },
      ...
      pushCartItem([
        {
          cartid: randomNumber,
          product: _omit(product.model || undefined, 'product_info'),
          atributColor: fields.color3,
          atributSpheries: fields.spheries3,
          atributBcurve: fields.basecurve3,
          qty: 1,
        },
      ])
    )
      ...
      return (
        <View style={[wrapper.row]}>
          <View style={{ flex: 1 }}>
            ...
            >
              <View style={[wrapper.row, { marginHorizontal: -5}]}>
                <Ionicons
                  name="ios-cart-outline"
                  size={16}
          ...
          {productModel.vto_active === 0 ? null : (
            <>
            ...
            {route.params.product?.description == 'CL' ? (
                  ...
                  <View>
                    ...
                    <View style={[wrapper.row, { marginTop: 5 }]}>
                      ...
                      <View style={{ flex: 1, alignItems: 'center' }}>
                        {route.params.product?.jeniswarna === 'clear' ?
                        (
                          <Typography size='sm' style={{paddingVertical: 10}}>{productModel.jeniswarna?.toUpperCase()}</Typography>
                        ):(
                          <SelectDropdown
              ...
              <>
                ...
                {route.params.product.qty === 0 ? (
                  ...
                  <>
                    <Typography size='xs' style={{paddingVertical: 5}}> Pilih Warna </Typography>
                    <View style={{ flex: 1}}>
                      <SelectDropdown
                    ...
                    <Typography size='xs' style={{paddingVertical: 5}}> Pilih Addition </Typography>
                    <View style={{ flex: 1}}>
                      {productModel.merk?.substring(0, 5) == 'ADLEN' ? null : (
                        <SelectDropdown
